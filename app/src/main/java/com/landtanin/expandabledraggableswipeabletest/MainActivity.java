...
import com.landtanin.expandabledraggableswipeabletest.fragment.ExampleExpandableDataProviderFragment;
import com.landtanin.expandabledraggableswipeabletest.fragment.ExpandableItemPinnedMessageDialogFragment;
...
public class MainActivity extends AppCompatActivity implements ExpandableItemPinnedMessageDialogFragment.EventListener {
    ...
    //    private List<HomeAlarmChildModel> models = new ArrayList<>();
...
//        expandableItemManager.attachRecyclerView(recyclerView);
        ...
        if (savedInstanceState == null) {
            ...
            ActivityUtils.addFragmentToActivity(
                    ...
                    new ExampleExpandableDataProviderFragment(),
    ...
    public void onGroupItemClicked(int groupPosition) {
        ...
        if (data.isPinned()) {
            ...
            ((MainFragment) fragment).notifyGroupItemChanged(groupPosition);
        }
    }
    ...
    public void onChildItemClicked(int groupPosition, int childPosition) {
        ...
        if (data.isPinned()) {
            // unpin if tapped the pinned item
            data.setPinned(false);
            ((MainFragment) fragment).notifyChildItemChanged(groupPosition, childPosition);
        }
    }
    ...
    private void onItemUndoActionClicked() {
        ...
        if (childPosition == RecyclerView.NO_POSITION) {
            // group item
            ((MainFragment) fragment).notifyGroupItemRestored(groupPosition);
        } else {
            // child item
            ((MainFragment) fragment).notifyChildItemRestored(groupPosition, childPosition);
        }
    }
